...
/*!****************************************************!*\
  ...
  \****************************************************/
/*! no static exports found */function(e,a,n){"use strict";var r=n(/*! moment */"./node_modules/moment/moment.js"),o=n(/*! ./socket_base */"./src/javascript/_common/base/socket_base.js"),t=n(/*! ../utility */"./src/javascript/_common/utility.js").PromiseClass,i=function(){var e=!1,a=new t,n=void 0,i=void 0,s=void 0,l=void 0,c=void 0,m=function(a){e||(c=a,u(),clearInterval(s),s=setInterval(u,3e4),e=!0)},u=function(){i=r().valueOf(),o.send({time:1}).then(d)},d=function(o){if(!o.error)if(e){clearInterval(l);var t=o.time,s=r().valueOf(),u=1e3*t+(s-i),d=function(){n=r(u+r().valueOf()-s).utc(),"function"==typeof c&&c()};d(),a.resolve(),l=setInterval(d,1e3)}else m()};return{init:m,get:function(){return n?n.clone():void 0},timePromise:a.promise}}();e.exports=i},"./src/javascript/_common/base/socket_base.js":
/*!****************************************************!*\
  !*** ./src/javascript/_common/base/socket_base.js ***!
  \****************************************************/
/*! no static exports found */function(e,a,n){"use strict";var r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},o=n(/*! ./client_base */"./src/javascript/_common/base/client_base.js"),t=n(/*! ./socket_cache */"./src/javascript/_common/base/socket_cache.js"),i=n(/*! ../language */"./src/javascript/_common/language.js").get,s=n(/*! ../storage */"./src/javascript/_common/storage.js").State,l=n(/*! ../utility */"./src/javascript/_common/utility.js").cloneObject,c=n(/*! ../utility */"./src/javascript/_common/utility.js").getPropertyValue,m=n(/*! ../utility */"./src/javascript/_common/utility.js").isEmptyObject,u=n(/*! ../utility */"./src/javascript/_common/utility.js").PromiseClass,d=n(/*! ../../config */"./src/javascript/config.js").getAppId,h=n(/*! ../../config */"./src/javascript/config.js").getSocketURL,g=function(){var e=void 0,a={},n=[],g=0,p=0,b=!0,y=!1,f=h()+"?app_id="+d()+"&l="+i(),k={},v={},w=["authorize","get_settings","residence_list","landing_company","payout_currencies","asset_index"],j={items:[],clear:function(){j.items=[]},has:function(e){return j.items.indexOf(e)>=0},add:function(e){j.has(e)||j.items.push(e)},remove:function(e){j.has(e)&&j.items.splice(j.items.indexOf(e,1))}},_={items:{},add:function(e,a){_.items[e]||(_.items[e]=[]),_.items[e].push(a)},resolve:function(e){var a=e.msg_type,n=_.items[a];n&&n.length&&(n.forEach(function(n){_.another_exists(n,a)||n.resolve(e)}),_.items[a]=[])},another_exists:function(e,a){return Object.keys(_.items).some(function(n){return n!==a&&-1!==_.items[n].indexOf(e)})}},x=function(){Object.keys(k).forEach(function(e){clearTimeout(k[e]),delete k[e]})},z=function(){return q(1)},q=function(){for(var a=arguments.length,n=Array(a),r=0;r<a;r++)n[r]=arguments[r];return e&&n.some(function(a){return e.readyState===a})},O=function(){for(;n.length>0&&b;){var e=n.shift();E(e.request,e.options)}},S=function(){for(var e=arguments.length,a=Array(e),n=0;n<e;n++)a[n]=arguments[n];var r=new u,t=!0;return a.forEach(function(e){var n=s.get(["response",e]);n?1===a.length&&r.resolve(n):("authorize"!==e||o.isLoggedIn())&&(_.add(e,r),t=!1)}),t&&r.resolve(),r.promise},E=function(r){var o=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=o.promise||new u;if(!r||m(r))return i.promise;var d=o.msg_type||w.find(function(e){return e in r});if(!o.forced){var h=t.get(r,d);if(h)return s.set(["response",d],l(h)),z()&&b&&e.send(JSON.stringify(r)),i.resolve(h),i.promise}if(!o.forced&&d&&-1!==w.indexOf(d)){var p=s.get(["response",d]);if(p)return i.resolve(p),i.promise;if(j.has(d))return S(d).then(function(e){return i.resolve(e),i.promise})}return r.req_id||(r.req_id=++g),v[r.req_id]={callback:function(e){"function"==typeof o.callback?o.callback(e):i.resolve(e)},subscribe:!!r.subscribe},z()&&b&&a.isOnline()?(y=!1,c(r,"passthrough")||c(r,"verify_email")||(r.passthrough={}),e.send(JSON.stringify(r)),a.wsEvent("send"),d&&!j.has(d)&&j.add(d)):1!=+r.time&&n.push({request:r,options:Object.assign(o,{promise:i})}),i.promise};return{init:function(i){p!==d()&&("object"===(void 0===i?"undefined":r(i))&&a!==i&&(a=i,n=[]),x(),a.wsEvent("init"),e&&!q(2,3)||(e=new WebSocket(f),s.set("response",{})),e.onopen=function(){a.wsEvent("open"),o.isLoggedIn()?E({authorize:o.get("token")},{forced:!0}):O(),"function"==typeof a.onOpen&&a.onOpen(z())},e.onmessage=function(e){a.wsEvent("message");var n=e.data?JSON.parse(e.data):void 0;if(n){t.set(n);var r=n.msg_type;c(n,["echo_req","subscribe"])&&!/balance|website_status/.test(r)||s.set(["response",r],l(n));var o=n.req_id,i=o?v[o]:null;i&&"function"==typeof i.callback&&(i.callback(n),i.subscribe||delete v[o]),_.resolve(n),"InvalidAppID"===c(n,["error","code"])&&(p=d()),"function"==typeof a.onMessage&&a.onMessage(n)}},e.onclose=function(){j.clear(),x(),a.wsEvent("close"),p===d()||"function"!=typeof a.onDisconnect||y||(a.onDisconnect(),y=!0)})},wait:S,send:E,clear:function(e){n=[],e&&(s.set(["response",e],void 0),j.remove(e))},clearTimeouts:x,availability:function(e){return void 0!==e&&(b=!!e),b},hasReadyState:q,sendBuffered:O,get:function(){return e},setOnDisconnect:function(e){a.onDisconnect=e},removeOnDisconnect:function(){delete a.onDisconnect}}}();e.exports=g},"./src/javascript/_common/base/socket_cache.js":
/*!*****************************************************!*\
