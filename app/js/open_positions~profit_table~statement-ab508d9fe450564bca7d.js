...
Object.keys(_progressSliderStream).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _progressSliderStream[key];
    }
  });
});
...
var getOpenPositionsColumnsTemplate = exports.getOpenPositionsColumnsTemplate = function getOpenPositionsColumnsTemplate(currency) {
    return [{
        ...
        renderCellContent: function renderCellContent(_ref12) {
            ...
            return _react2.default.createElement(_ProgressSliderStream2.default, {
