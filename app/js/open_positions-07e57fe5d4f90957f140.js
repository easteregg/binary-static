...
var OpenPositions = function (_React$Component) {
    ...
    _createClass(OpenPositions, [{
        ...
        value: function render() {
            ...
            var columns = (0, _dataTableConstants.getOpenPositionsColumnsTemplate)();
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_placeholderComponent2.default, {
                            ...
                            is_empty: is_empty,
                            empty_message_component: _emptyOpenPositionsMessage2.default
                        })
                    )
                )
            );
...
exports.default = (0, _connect.connect)(function (_ref) {
    ...
    return {
        ...
        handleScroll: modules.portfolio.handleScroll,
        has_selected_date: modules.portfolio.has_selected_date,
        is_empty: modules.portfolio.is_empty,
        is_loading: modules.portfolio.is_loading,
        onMount: modules.portfolio.onMount,
        onUnmount: modules.portfolio.onUnmount
    };
})((0, _reactRouter.withRouter)(OpenPositions));
