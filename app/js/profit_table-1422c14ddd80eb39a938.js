...
exports.default = (0, _connect.connect)(function (_ref) {
    ...
    return {
        data: modules.profit.data,
        error: modules.profit.error,
        handleScroll: modules.profit.handleScroll,
        has_selected_date: modules.profit.has_selected_date,
        is_empty: modules.profit.is_empty,
        is_loading: modules.profit.is_loading,
        onMount: modules.profit.onMount,
        onUnmount: modules.profit.onUnmount
    };
