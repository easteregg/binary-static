...
var ContractReplay = function (_React$Component) {
    ...
    _createClass(ContractReplay, [{
        ...
        value: function render() {
            ...
            if (status) {
                console.log(JSON.stringify(this.props.contract_info));
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(SmartChart, {
                        ...
                        start_epoch: this.props.contract_info.date_start,
                        end_epoch: this.props.contract_info.date_expiry,
                        scroll_to_epoch: this.props.contract_info.date_expiry
