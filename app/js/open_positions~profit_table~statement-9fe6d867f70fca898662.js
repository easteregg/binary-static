...
var ServerTime = _interopRequireWildcard(_server_time);

var _helpers = __webpack_require__(/*! ../../../App/Components/Elements/PositionsDrawer/helpers */ "./src/javascript/app_2/App/Components/Elements/PositionsDrawer/helpers/index.js");

var _ProgressSlider = __webpack_require__(/*! ../../../App/Components/Elements/PositionsDrawer/ProgressSlider */ "./src/javascript/app_2/App/Components/Elements/PositionsDrawer/ProgressSlider/index.js");
    ...
    return [{
        ...
        renderCellContent: function renderCellContent(_ref10) {
            var cell_value = _ref10.cell_value,
                row_obj = _ref10.row_obj;
            return _react2.default.createElement(_ProgressSlider2.default, {
                remaining_time: cell_value //const percentage = getTimePercentage(server_time, contract_info.purchase_time, contract_info.date_expiry);
                , percentage: (0, _helpers.getTimePercentage)(ServerTime.get(), row_obj.purchase_time, cell_value),
